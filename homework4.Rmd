...
dim(ntpuLogoRaster) #找出邊界各別為多少
ntpuLogoRaster_redFrame_matrix <-  as.matrix(ntpuLogoRaster)
ntpuLogoRaster_redFrame_matrix <- as.matrix(ntpuLogoRaster_redFrame_matrix, 
                                     ntpuLogoRaster[1,1:300] <- "red",
                                     ntpuLogoRaster[183,1:300] <- "red",
                                     ntpuLogoRaster[1:183,1] <- "red",
                                     ntpuLogoRaster[1:183,300] <- "red")
ntpuLogoRaster_redFrame <- as.raster(ntpuLogoRaster_redFrame_matrix)

plot(ntpuLogoRaster_redFrame) #test
```
...
ntpuLogoRaster <- as.raster(ntpuLogoRaster,
                            ntpuLogoRaster[1,1:300] <- "transparent",
                            ntpuLogoRaster[183,1:300] <- "transparent",
                            ntpuLogoRaster[1:183,1] <-"transparent",
                            ntpuLogoRaster[1:183,300] <-"transparent")

ntpuLogoRaster_greySelect <- as.raster(ntpuLogoRaster,
                                       ntpuLogoRaster[105:145,55:95] <- "grey")

plot(ntpuLogoRaster_greySelect) #test
```
